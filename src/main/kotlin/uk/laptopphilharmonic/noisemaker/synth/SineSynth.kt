...
//    override fun createBuffer(laptopphilharmonic.uk.noisemaker.frequency: Frequency, millis: Int, velocity: Int): ByteArray {
//        require(velocity in 0..127)
//        val byteDepth = bitDepth / 8
//        val output = ByteArray((millis * samplesPerSecond * byteDepth) / 1000)
//        val period = (samplesPerSecond.toDouble() / laptopphilharmonic.uk.noisemaker.frequency.hz) * byteDepth
